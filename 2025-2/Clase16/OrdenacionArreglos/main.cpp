...
int main(int argc, char** argv) {
    ...
    //    
    leer_insertar_ordenado("videojuegos.txt", codigos, fechas, pg13s, precios, cantidad_juegos);
    imprimir_datos("ReporteVideojuegosInsertarOrdenado.txt", codigos, fechas, pg13s, precios, cantidad_juegos);
